...
class FiltreTwo extends StatefulWidget {
  const FiltreTwo({Key? key}) : super(key: key);

  @override
  State<FiltreTwo> createState() => _FiltreTwoState();
}

class _FiltreTwoState extends State<FiltreTwo> {
                                  ...
                                  Column (
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: ListTile(
                                          title: Text("Fast Delivery",style: TextStyle(
                                            fontSize: 20,
                                      ...
                                      Container(
                                        margin : EdgeInsets.only(left: 10),
                                        child: ListTile(
                                          title: Text("Previous Orders",style: TextStyle(
                                            fontSize: 20,
                                            fontWeight: FontWeight.w700,
                                            fontFamily: 'Montserrat',
                                          ),),
                                      ...
                                      Container(
                                        ...
                                        child: Text('Max Orders Prices',style: TextStyle(
                                          fontSize: 20,
                                          fontWeight: FontWeight.w700,
                                          fontFamily: 'Montserrat',
                                        ),),
