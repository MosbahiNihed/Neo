...
import 'generatedaccwithpwidget/generated/GeneratedAvatarBackgroundWidget.dart';
import 'generatedaccwithpwidget/generated/GeneratedAvatarWidget.dart';
import 'generatedaccwithpwidget/generated/GeneratedHiUserWidget.dart';
...
class AccesWithAccount extends StatefulWidget {
  const AccesWithAccount({Key? key}) : super(key: key);

  @override
  State<AccesWithAccount> createState() => _AccesWithAccountState();
}

class _AccesWithAccountState extends State<AccesWithAccount> {
   double rat1 = 0.0;
   double rating = 0.0;
   double rat2 = 0.0;
   double rat3 = 0.0;
